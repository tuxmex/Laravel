...
class BlogPostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($blogPost->save()){
            ...
            return redirect()->back()->with('success', 'Blog post saved successfully!');
        }
    
        return redirect()->back()->with('failed', 'Blog post Could not save!'); 
    ...
    public function destroy($id)
    {
        ...
        if(BlogPost::destroy($id)){
            return redirect()->back()->with('destroy', 'Blog post deleted successfully!');
        }
    
        return redirect()->back()->with('failed', 'Blog post Could not delete!'); 
